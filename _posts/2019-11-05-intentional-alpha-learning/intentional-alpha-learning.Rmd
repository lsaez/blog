...
```{r out.height="100px",out.width="200px",fig.align="center"}
knitr::include_graphics("intentional-alpha-learning_files/Apple2.PNG")
```
...
knitr::include_graphics("intentional-alpha-learning_files/popcorn.png")
```
